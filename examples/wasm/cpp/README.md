# FreeCAD C++ Wasm Addon

This example builds the capability guest used by the WAMR integration tests.
It uses the freestanding C++ guest client, so it does not require WASI,
libc++, or a full FreeCAD build.
