...
private Q_SLOTS:
    void init()  // NOLINT
    {
        ...
        callbacks.onStateChanged = [this]() { ++callbackState.stateChangedCount; };
    ...
    {
        const std::string emptyDocName =
            App::GetApplication().getUniqueDocumentName("async_progress_empty");
