...
TEST_F(Expression, tokenize)
{
    ...
    // 0.0000 deg-
    EXPECT_TRUE(App::ExpressionTokenizer().perform("0.00000 \xC2\xB0-", 10).empty());
    EXPECT_EQ(App::ExpressionTokenizer().perform("0.00000 \xC2\xB0-s", 11), "s");
    EXPECT_EQ(App::ExpressionTokenizer().perform("0.00000 \xC2\xB0-ss", 12), "ss");
