...
def exercise(
    ...
    assert_type(hypothesis.getLength(), float)
    assert_type(hypothesis.getLibName(), str)
    assert_type(hypothesis.getUsePreestimatedLength(), bool)
    assert_type(regular_hypothesis.isAuxiliary(), bool)
    assert_type(segment_hypothesis.getNumberOfSegments(), int)
    protector.recompute()
    ...
    reveal_type(fem_mesh)
    reveal_type(hypothesis)
    reveal_type(regular_hypothesis)
    reveal_type(segment_hypothesis)
