...
#ifndef BASE_STRING_TOKENIZER_H
#define BASE_STRING_TOKENIZER_H
...
inline std::vector<std::string> splitAnyOf(std::string_view text,
...
inline std::vector<std::string> splitEscaped(std::string_view text,
                                             char delimiter,
                                             char quoteChar,
                                             char escapeChar)
{
