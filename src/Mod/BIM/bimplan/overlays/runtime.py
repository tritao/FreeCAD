...
_PLAN_SESSION_OVERLAY_COMPAT_METHODS = (
    ...
    "_clear_secondary_selected_overlays",
    "_sync_space_region_pick_overlays",
    "_clear_space_region_pick_overlays",
    "_sync_hovered_wall_overlay",
    "_clear_hovered_wall_overlay",
    "_sync_selected_wall_overlay",
    "_clear_selected_wall_overlay",
    "_get_plan_context_junctions",
    "_create_junction_node_trackers",
    "_sync_junction_node_overlays",
    "_clear_junction_node_overlays",
    "_sync_hovered_wall_opening_context_overlay",
    "_clear_hovered_wall_opening_context_overlay",
    "_create_wall_overlay_trackers",
    "_create_space_overlay_trackers",
    "_create_region_overlay_trackers",
    "_get_region_overlay_segments",
    "_get_space_overlay_segments",
    "_sync_hovered_space_overlay",
    "_clear_hovered_space_overlay",
    "_sync_hovered_region_overlay",
    "_clear_hovered_region_overlay",
    "_invalidate_selected_space_overlay_cache",
    "_sync_selected_space_overlay",
    "_clear_selected_space_overlay",
    "_sync_selected_region_overlay",
    "_clear_selected_region_overlay",
    "_sync_provider_overlays",
    "_clear_provider_overlays",
    "_sync_hovered_provider_overlay",
    "_clear_hovered_provider_overlay",
    "_sync_selected_provider_overlay",
    "_clear_selected_provider_overlay",
    "_get_selected_provider_handle_specs",
    "_sync_selected_provider_handles",
    "_clear_selected_provider_handles",
    "_pick_selected_provider_handle",
    "_sync_provider_point_preview",
    "_clear_provider_point_preview",
    "_sync_hovered_opening_overlay",
    "_clear_hovered_opening_overlay",
    "_invalidate_hovered_opening_overlay_cache",
    "_create_opening_overlay_trackers",
    "_get_opening_overlay_segments",
    "_sync_selected_opening_overlay",
    "_clear_selected_opening_overlay",
    "_invalidate_selected_opening_overlay_cache",
    "_sync_selected_wall_opening_context_overlay",
    "_clear_selected_wall_opening_context_overlay",
    "_get_symbol_global_placement",
    "_get_symbol_parent_global_placement",
    "_get_symbol_plan_proxy",
    "_get_symbol_semantic_proxy",
    "_get_symbol_overlay_polylines",
    "_get_symbol_overlay_segments",
    "_get_plan_symbol_instances",
    "_get_symbol_overlay_screen_polylines",
    "_refresh_selected_symbol_visuals",
    "_create_symbol_overlay_trackers",
    "_sync_hovered_symbol_overlay",
    "_clear_hovered_symbol_overlay",
    "_sync_selected_symbol_overlay",
    "_clear_selected_symbol_overlay",
    "_get_symbol_rotation_snap_increment_degrees",
    "_get_symbol_rotation_snap_step_radians",
    "_symbol_rotation_free_angle_override_active",
    "_resolve_symbol_handle_target_point",
    "_get_symbol_handle_radius",
    "_get_selected_symbol_handle_specs",
    "_sync_selected_symbol_handles",
    "_clear_selected_symbol_handles",
    "_pick_selected_symbol_handle",
    "_get_symbol_local_anchor",
    "_get_symbol_local_facing",
    "_get_selected_opening_handle_specs",
    "_sync_selected_opening_handles",
    "_clear_selected_opening_handles",
)
