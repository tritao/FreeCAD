...
class PlanViewportAPI:
    ...
    def discard_queued_view_updates(self):
        return discard_queued_view_updates(self.session)
...
def flush_scene_graph_mutations(session):
    """Apply queued graph changes after Coin has returned from event traversal."""
