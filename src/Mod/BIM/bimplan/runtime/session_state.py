...
class PlanSelectionSyncState:
    ...
    clear_gui_preselection_queued: bool = False
...
class PlanViewportState:
    ...
    scene_graph_mutations: dict = field(default_factory=dict)
    scene_graph_flush_queued: bool = False
...
class PlanCreationPreviewState:
    ...
    wall_preview_source: object = None
