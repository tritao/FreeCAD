...
def format_opening_selection_help(session, opening):
    ...
    if opening_kind == "Window":
        ...
        can_edit_width = session.hosted_openings.can_edit_window_width(opening)
        can_edit_height = session.hosted_openings.can_edit_window_height(opening)
        can_apply_style = session.hosted_openings.can_apply_window_style_preset(opening)
