...
void ViewProviderDragger::setDraggerInteractionHandler(
    std::function<void(DraggerInteraction)> handler
)
{
...
bool ViewProviderDragger::setEdit(int ModNum)
{
    ...
    Gui::installDraggerInteractionCallbacks<
        ViewProviderDragger,
        &ViewProviderDragger::handleDraggerInteraction>(transformDragger.get(), this);
