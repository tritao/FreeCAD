...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleIdle(const NavigationEventView& event)
{
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleAwaitingMove(
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleRotate(
    const NavigationEventView& event
)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handlePan(const NavigationEventView& event)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleStickyPan(
    const NavigationEventView& event
)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleTilt(const NavigationEventView& event)
{
    EventOutcome outcome;
    auto& data = std::get<MotionData>(stateData);
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleGesture(
    const NavigationEventView& event
)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleAwaitingRelease(
    const NavigationEventView& event
)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::handleInteract(
    const NavigationEventView& event
)
{
    EventOutcome outcome;
...
GestureNavigationStyle::EventOutcome GestureNavigationStyle::dispatchEvent(const SoEvent* event)
{
...
SbBool GestureNavigationStyle::processSoEvent(const SoEvent* const ev)
{
    ...
    const EventOutcome outcome = dispatchEvent(ev);
