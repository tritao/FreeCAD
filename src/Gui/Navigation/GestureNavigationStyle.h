...
protected:
    ...
    EventOutcome dispatchEvent(const SoEvent* event);
    EventOutcome handleIdle(const NavigationEventView& event);
    EventOutcome handleAwaitingRelease(const NavigationEventView& event);
    EventOutcome handleAwaitingMove(const NavigationEventView& event);
    EventOutcome handleRotate(const NavigationEventView& event);
    EventOutcome handlePan(const NavigationEventView& event);
    EventOutcome handleStickyPan(const NavigationEventView& event);
    EventOutcome handleTilt(const NavigationEventView& event);
    EventOutcome handleGesture(const NavigationEventView& event);
    EventOutcome handleInteract(const NavigationEventView& event);
