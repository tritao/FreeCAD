...
class _View3DInventor:
    ...
    def setCameraOrientation(
        self, rotation: Rotation | tuple[float, float, float, float], move_to_rotation_center: bool = False, /
    ) -> None:
    ...
    def getPointOnScreen(
        self, point: Vector | tuple[float, float, float], /
    ) -> tuple[int, int]:
        """Project one world-space point onto the screen."""
        ...
    def getPointOnViewport(
        self, point: Vector | tuple[float, float, float], /
    ) -> tuple[int, int]:
