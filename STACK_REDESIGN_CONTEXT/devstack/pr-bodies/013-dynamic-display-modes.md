...
> [!IMPORTANT]
> Part `13/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/012-viewer-session-appearance`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`7/10`)
