...
> [!IMPORTANT]
> Part `10/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/009-camera-capture`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`4/10`)
