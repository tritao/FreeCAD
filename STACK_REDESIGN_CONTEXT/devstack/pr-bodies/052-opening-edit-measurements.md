---
title: "BIM: show opening edit measurements"
---

## Summary

Shows live, unit-aware width and host-offset labels while moving and resizing hosted openings.

## Why

Opening handles need precise feedback before a semantic edit is committed.

## Architectural invariant

> BIM operations provide semantic measurement text; the viewer renders it without interpreting architectural properties.

## Changes

- adds optional preview-label output to semantic edit operations
- reports opening width for either jamb resize
- reports host-axis offset while moving an opening
- follows the active handle and uses invalid-state styling
- removes labels atomically with preview cancellation, commit, or teardown

## Tests

- 27 renderer-neutral representation and contextual-edit tests
- real Coin opening move/resize/flip/undo/re-entry test

## Intentionally deferred

Snapping badges and editable in-canvas fields can reuse this overlay foundation later.

<!-- AUTOGEN:BEGIN -->
### Patch Set

> [!IMPORTANT]
> Part `52/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/051-overlay-labels`; review and merge in order.

- Group: `overlay-feedback` — Overlay feedback and measurements (`2/2`)
