...
> [!IMPORTANT]
> Part `7/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/006-view-provider-back-root`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`1/10`)
