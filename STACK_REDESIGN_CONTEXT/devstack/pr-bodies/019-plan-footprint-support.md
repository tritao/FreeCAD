...
> [!IMPORTANT]
> Part `20/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/019-bim-representation-contract`; review and merge in order.
