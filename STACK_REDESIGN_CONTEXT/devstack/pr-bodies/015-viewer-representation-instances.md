...
> [!IMPORTANT]
> Part `15/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/014-contextual-task-view`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`9/10`)
