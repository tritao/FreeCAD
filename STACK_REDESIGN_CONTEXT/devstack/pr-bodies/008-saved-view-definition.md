...
> [!IMPORTANT]
> Part `8/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/007-view-context`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`2/10`)
