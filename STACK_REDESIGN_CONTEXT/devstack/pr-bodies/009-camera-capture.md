...
> [!IMPORTANT]
> Part `9/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/008-saved-view-definition`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`3/10`)
