...
> [!IMPORTANT]
> Part `37/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/036-techdraw-consumer`; review and merge in order.

- Group: `consumers-examples` — Consumers and end-to-end examples (`2/2`)
