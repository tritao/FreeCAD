...
> [!IMPORTANT]
> Part `14/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/013-dynamic-display-modes`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`8/10`)
