...
> [!IMPORTANT]
> Part `11/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/010-contextual-clipping`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`5/10`)
