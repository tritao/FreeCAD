...
> [!IMPORTANT]
> Part `12/52` of a stacked series. Depends on `pr/unified-bim-plan-perfect/011-workbench-context-policy`; review and merge in order.

- Group: `contextual-views` — Contextual views and viewer-local realization (`6/10`)
